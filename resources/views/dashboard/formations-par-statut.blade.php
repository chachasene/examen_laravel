...
@section('content')
<div>
    <h3>Statistique des Formations</h3>
</div>
...
<div>
    <table class="table">
        ...
        <tr>
            ...
            <td colspan="2">
                <h2>Désolé, aucune donnée à représenter.</h2>
            </td>
...
g.append("text")
    ...
    .attr("dy", ".35em")
    .text(function(d) {
        return (d.data.isStarted ? 'En_cours' : 'En_attente') + "(" + d.data.total + ")";
    });
</script>
@endsection
